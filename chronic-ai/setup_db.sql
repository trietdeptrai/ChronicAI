...
CREATE TYPE appointment_contact_method AS ENUM ('phone', 'sms', 'app');
...
COMMENT ON TABLE appointments IS 'Patient booking requests and doctor appointment decisions';
