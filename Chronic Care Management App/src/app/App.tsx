...
export default function App() {
  ...
  const [selectedPatientId, setSelectedPatientId] = useState<string>('p1'); // For patient view

  if (!userRole) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundImage: "linear-gradient(128.348deg, rgb(232, 244, 248) 3.4766%, rgb(171, 216, 255) 28.535%, rgb(224, 242, 254) 54.018%, rgb(232, 224, 254) 87.416%)" }}>
        <div className="max-w-4xl w-full">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold text-[#1e2939]">MediCare Pro</h1>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-[#1e2939] mb-2">Bác sĩ</h2>
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-[#1e2939] mb-2">Bệnh nhân</h2>
              <p className="text-[#4a5565] mb-4">
          ...
          <div className="mt-8 p-4 bg-[rgba(255,255,255,0.4)] border border-white rounded-[16px] shadow-[0px_8px_30px_0px_rgba(0,0,0,0.04)]">
  ...
  return (
    <div className="min-h-screen" style={{ backgroundImage: "linear-gradient(128.348deg, rgb(232, 244, 248) 3.4766%, rgb(171, 216, 255) 28.535%, rgb(224, 242, 254) 54.018%, rgb(232, 224, 254) 87.416%)" }}>
      {userRole === 'doctor' ? (
        <DoctorDashboard onLogout={() => setUserRole(null)} />
      ) : (
        <PatientDashboard patientId={selectedPatientId} onLogout={() => setUserRole(null)} />
      )}
    </div>
  );
}