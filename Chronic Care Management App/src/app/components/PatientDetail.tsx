...
import { mockPatients, MedicalRecord, getDiseaseInfo } from '@/data/mockData';
import { MedicalTimeline } from '@/app/components/MedicalTimeline';
import { AIChat } from '@/app/components/AIChat';
import { DocumentUpload } from '@/app/components/DocumentUpload';
import { User, Calendar, Activity, Upload, MessageSquare, FileText, AlertCircle } from 'lucide-react';
...
export function PatientDetail({ patientId, records, isDoctor }: PatientDetailProps) {
